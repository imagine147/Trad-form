  ...
  return (
      ...
      <div className='grid  justify-items-center w-[80%] mx-auto'>
        <form  action="" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className='bg-[#7C20BF] w-full rounded-sm py-2 text-white text-center '>
          <button className='' type='submit'>Sign Up</button>
          </div>
          </div>

          <div>
           <Link to='/Login'> <h3 className='text-black text-sm text-center  pt-8'>Already have an account? <span className='text-[#7C20BF] '>Click here</span></h3></Link>
          </div>
        </form>
      </div>
